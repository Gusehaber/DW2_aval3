                                ...
                                <table width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Preço do produto" style="width: 206px;">Contato</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <${resultadofornecedor}
                                        <%// <select class="form-control" name="formulario">
                                            //<c:forEach var="form" items="${dao.listInOrderNome()}">
                                            //  <tr>
                                                //   <td>${cat.getIdCategoria()}</td>
                                                //   <td>${cat.getNomeCategoria()}</td>
                                                // </tr> 
                                           // <option value="${form.getIDFornecedor()}">${form.getNomeFornecedor()}</option>
                                        //</c:forEach>
                                   // </select>%>
                                    </tbody>
                                </table></div></div>
